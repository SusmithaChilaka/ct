 ...
 *
 */
public abstract class TraacsRoeCapture implements ExecutableComponent {
	...
	public Object onCall(TraacsRoeRequest roeRQ) throws Exception {
		...
		auth.setSTR_USER_NAME("guest");
		auth.setSTR_PASSWORD("guest123");
		
		for(Map<String, String> roe : roeRQ.getRoeDetails().get("SAR")){
			if(null != roe){
