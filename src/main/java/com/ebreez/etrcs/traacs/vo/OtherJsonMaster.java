...
public class OtherJsonMaster implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 43545435L;
	...
	@JsonProperty("STR_PARTICULARS")
	private String STR_PARTICULARS;
	...
	@JsonProperty("STR_CUSTOMER_CC_NO")
	private String STR_CUSTOMER_CC_NO;
	...
	public String getSTR_PARTICULARS() {
		return STR_PARTICULARS;
	}

	public void setSTR_PARTICULARS(String sTR_PARTICULARS) {
		STR_PARTICULARS = sTR_PARTICULARS;
	}
	...
	public String getSTR_CUSTOMER_CC_NO() {
		return STR_CUSTOMER_CC_NO;
	}

	public void setSTR_CUSTOMER_CC_NO(String sTR_CUSTOMER_CC_NO) {
		STR_CUSTOMER_CC_NO = sTR_CUSTOMER_CC_NO;
	}
